			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 md-margin-bottom-40">
						<a href="index.php"><img class="footer-logo" src="assets/img/footerlogo.png" alt=""></a>
						<p>VIP-VELIK лучший контроль качества</p>
					...
					<div class="col-md-8 col-sm-3">
						<div class="row">
							<div class="col-sm-6 col-xs-6">
								<h2 class="thumb-headline">Адрес / Контакты</h2>
								<ul class="list-unstyled address-list margin-bottom-20">
									<li><i class="fa fa-angle-right"></i>Истина где то рядом</li>
									<li><i class="fa fa-angle-right"></i>Тел.: +7 914 720-80-33</li>
									<li><i class="fa fa-angle-right"></i>Email: info@mail.ru</li>
								</ul>
							</div>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<p>
							2016 &copy; VIP-VELIK. Все права защищены. | Разработка: 
							<a target="_blank" href="http://weeble.pro">Weeble Group</a>
						</p>
					</div>
					<div class="col-md-6">
...
<script type="text/javascript" src="assets/plugins/counter/waypoints.js"></script>
<!-- Master Slider -->
